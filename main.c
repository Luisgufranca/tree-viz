...
/*primeiro, vou implementar as funções que me permitem incluir, procurar, remover
estruturas de uma árvore binária de pesquisa. depois eu faço uma interfacezinha pra
vizualizar isso em alguma biblioteca de interface em c*/
...
TNodoA* removeABP(TNodoA *a, int chave)
{
    ...
    TNodoA *pai = a; //variavel para apontar para o pai do nodo buscado
    int qual; //variavel para indicar se o nodo procurado é
    ...
    else
    {
        ...
        //atual2 pode ter uma subárvore na sua esquerda ou não no fim do loop.
        if(atual2->esq == NULL)
            pai2->dir = NULL;
        else
            pai2->dir = atual2->esq;
